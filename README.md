...
### v0.1.1 (开发中)
- ✅ 修复缺失的应用启动图标资源，解决 `assembleRelease` 在资源打包阶段的失败问题
- 🔄 新增统一的矢量版 BrowserOS 图标（圆角矩形与圆形两种样式），确保 GitHub Action 构建可以顺利完成
- 📌 后续计划增加多分辨率位图资源，以提升在旧设备上的显示效果
...
### 已知问题
- 旧版 Android 设备目前使用矢量启动图标，后续需要补充不同分辨率位图以获得更好的显示效果
