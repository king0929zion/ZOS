...
public class AnthropicProvider implements AIService {
    ...
    public AnthropicProvider(String apiKey) {
        this(apiKey, "claude-3-sonnet-20240229");
    }
    ...
    public void chat(String message, AICallback callback) {
        if (apiKey == null || apiKey.isEmpty()) {
            callback.onError("Anthropic API 密钥未配置");
            return;
        }
        ...
        try {
            ...
            httpClient.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(Call call, IOException e) {
                    Log.e(TAG, "Anthropic API 请求失败", e);
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    if (!response.isSuccessful()) {
                        ...
                        Log.e(TAG, "Anthropic API 错误: " + response.code() + " - " + errorBody);
